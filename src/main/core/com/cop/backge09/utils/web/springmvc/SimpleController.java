...
import com.cop.backge09.utils.utils.BeanValidators;
import com.cop.backge09.utils.utils.DateUtils;
...
public abstract class SimpleController{
     ...
     * @return 指定JSP页面
     */
    @RequestMapping("go/{pageName}")
    public String redirectJsp( @PathVariable String pageName) {
        return pageName;
    }
